  ...
  return (
    <div className='py-16 pl-16  flex justify-between w-full'>
      ...
      <div className='md:w-[20%] min-w-[250px]'>
        <div>
          <Link href='/profile/NewProduct' className="hover:bg-[#A042E1] hover:text-white text-gray-600 font-comfortaa inline-flex items-center bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 rounded-[12px] shadow">
            <AiOutlinePlus className='text-[20px]'/> &nbsp;LIst new Product
          </Link>
        </div>
        <div>
        <Link href="/profile" className="hover:bg-[#A042E1] hover:text-white text-gray-600 font-comfortaa inline-flex items-center bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 rounded-[12px] shadow mt-5">
