  ...
  return (
    <div className='p-16 w-full'>
      ...
      <div className='max-w-[900px] font-comfortaa'>
        ...
        <div className='mt-12'>
          <label className="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Add New Address</label>
          <Link href="/profile/NewAddress" className='w-[60px] h-[60px] rounded-lg border-2 border-gray-300 border-dashed flex items-center justify-center cursor-pointer'>
