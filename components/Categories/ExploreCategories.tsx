    ...
    <>
      <div className="m-auto">
        ...
        <div className="flex flex-row flex-wrap justify-center ">
          <div className="bg-[url(/images/multiverse.png)] bg-no-repeat w-[500px] bg-contain h-[580px] mt-14 p-8">
          ...
          <div className=" flex flex-wrap items-center pt-12 justify-center">
            <div className="p-4">
              <div className="bg-[url(/images/magia.png)] bg-no-repeat bg-contain h-[260px] w-[500px] p-8 mb-10">
